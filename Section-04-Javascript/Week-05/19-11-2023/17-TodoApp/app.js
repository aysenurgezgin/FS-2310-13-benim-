...
let isEditMode=false;//Eğer bu değişkne false ise Yeni kayıt modundayız,true ise Düzenleme modundayız.
let editTaskId;//O anda hangi görev düzenleniyor ise uygulama boyunca geçerli olacak şekilde o görevin id'sini tutmaya yarar.
let filterMode="all";  //? tam olarak ne işe yarıyor
...
function addTask(event) {
    ...
    alert("Lütfen görev açıklamasıını boş bırakmayınız.")

}
txtTaskDescription.value="";
txtTaskDescription.focus();
}
// Buraya kadar kendim yadım ??
