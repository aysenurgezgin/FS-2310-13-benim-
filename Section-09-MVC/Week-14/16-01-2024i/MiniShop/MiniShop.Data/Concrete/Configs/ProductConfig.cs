...
namespace MiniShop.Data.Concrete.Configs
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
           ...
           // builder.Property(p => p.CreatedDate).HasDefaultValueSql("getdate()"); sql server için kullanlır
            builder.Property(p => p.CreatedDate).HasDefaultValueSql("date('now')");//sqlite için kullanımı
            builder.Property(p => p.ModifiedDate).HasDefaultValueSql("date('now')");//sqlite için kullanımı
