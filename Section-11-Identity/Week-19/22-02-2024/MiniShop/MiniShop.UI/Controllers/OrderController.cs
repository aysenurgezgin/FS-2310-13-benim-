...
namespace MiniShop.UI.Controllers
{
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(OrderViewModel orderViewModel)
        {
            ...
            //Yapılacak ödeme isteğinin autorazi seçenekeri için nesne oluşturuyor;
            Options options = new Options();
            options.ApiKey = "sandbox-y4RDHEHC8GInZuW17bZQeGOiIwG54HQi";
            options.SecretKey = "sandbox-UVEzXhVDLVP0CYkOP1frJZr92dcKR5eh";
            options.BaseUrl = "https://sandbox-api.iyzipay.com";


            // Yapılacak ödeme işlemi içn nesne oluşturulyor;
            ...
            //Ödemenin yapılacağı kart için nesne oluşturuluyor;
            ...
            //Alıcı biligileri için nesne oluşturuluyor;
            ...
            //Sepet ürünleri için nesne üretliliyor
