// 1)Bir js programını  geliştirirken şu ana kadar tüm örnklerde bir ap js dosya oluşturup ne yazdıysak her şeyi oraya yazdık ama gerçek dünyada yüzlerce kod yazamaız gereken durumlada parçalayarak yazmamız gerekecek tek bir dosya da çalışamayız,fonk fonk ayırırsın orada yaptığın şeyi işlev işle öyle ayırırsın mesela ürün kaydı yapan js dosyan olabilir ama içinde bir sürü ürün kaydın olabilir ama orının asıl işlevi; ürün kaydetmektir gibi,nihayi olarak yine ideal olan(kolaylık açısından) şey herşeyin tek bir dosya içinde olması ve tarayıcıyı öyle çalıştırmaktır.Preformans olarak bir
...
// basit bir mantık var=süslü parantez aç ve sonra alacağın fonksiyona vereceğin ismi söyle ya da alacağın ilgili modül dosyasından alacağın fonksiyonun adı nedir onu söyle.gettotal dediğimde ben oradan gettotali alıcam diyorum peki nereden? =süslü parantezin dışına çıkıyorum
