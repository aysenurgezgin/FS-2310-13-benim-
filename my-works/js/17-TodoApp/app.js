...
let taskListArray=[
    ...
    {id: 15, taskDescription:"Çok kilo aldın,az yemek ye!", status:"pending"},
];
 btnAddTask.addEventListener("click",function (event) {
    ...
    if(value != ""){
        ...
        alert("Lütfen görev açıklmasını boş bırakmayınız.")
    }
 ...
 function displayTasks() {
    ...
    taskList.innerHTML="";
    if (taskListArray.lenght==0) {
        taskList.innerHTML=`<div class="alert alert-warning mb-0"> Tanımlı görev bulunmaktadır.</div> `;
    }else{
