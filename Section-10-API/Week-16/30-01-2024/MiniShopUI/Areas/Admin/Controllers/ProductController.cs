...
namespace MiniShop.MVC.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> SoftDelete(int id)
        {
            ...
            //return RedirectToAction("Index");
            //return RedirectToAction("Index"); redicttery farklı kullanımlarını araştır.
            //TempData isimli veri taşıma yöntemini araştır.ViewBag ile temel farkını anlamaya çalış.
